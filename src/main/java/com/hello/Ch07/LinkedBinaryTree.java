...
/**
 * A reference based implementation of a binary tree. Javadoc comments for
 * methods specified in the BinaryTree interface have been omitted.
 *
...
public class LinkedBinaryTree<T> implements BinaryTree<T> {
	 ...
	 * C A E B D
	 */
	private void treeToString(BinaryTreeNode<T> cur, StringBuffer str,
			String indent) {
