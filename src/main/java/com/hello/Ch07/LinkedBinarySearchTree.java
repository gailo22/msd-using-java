 ...
 */
public class LinkedBinarySearchTree<T extends Comparable> implements
		BinarySearchTree<T> {
	 ...
	 *
	 * Preconditions: The data to be added is not equal to any data currently in
	 * the tree.
	 *
	 * Postconditions: The size of the tree has increased by one. The element
	 * added is in the correct position within the tree.
	 *
	 * @param data
	...
	/**
	 * Return a string representation of this tree. The string contains the
	 * elements in the tree listed in the order they were found during an
	...
	/**
	 * Perform an inorder traversal of the tree. When a node is processed, the
	 * contents of the node are converted to a string and appended to the
	 * specified string buffer.
	 *
	 * @param root
	 *            the root of the tree to traverse.
	 * @param result
	 *            the string buffer that will contain the string repsentations
