...
public class BinaryTreeNode<T> {
	 ...
	 * Preconditions: None
	 * 
	 * Postconditions: This node is unchanged.
	 * 
	 ...
	 * Preconditions: None
	 * 
	 * Postconditions: This node's left subchild has been changed to the given
	 * node.
	 *
	 * @param newLeft
	 *            the node to become this node's left child.
	 */
	 ...
	 * Preconditions: None
	 * 
	 * Postconditions: This node's right subchild has been changed to the given
	 * node.
	 *
	 * @param newRight
	 *            the node to become this node's left child.
	 ...
	 * Preconditions: None
	 * 
	 * Postconditions: This node's data field has been updated.
	 *
	 * @param newData
	 *            Node to become this node's right child.
	 */
	...
	/**
	 * Performs an inorder traversal of the BinaryTree rooted at this node. Each
	 * visited node is visited with the given callback.
	 *
	 * Preconditions: cb is not null
	 *
	 * Postconditions: All nodes in the tree have been visited by the given
	 * callback in the specified order.
	 *
	 * @param cb
	 *            the callback object used to process nodes.
	 */
	...
	/**
	 * Performs a preorder traversal of the BinaryTree rooted at this node. Each
	 * visited node is visited with the given callback.
	 *
	 * Preconditions: cb is not null
	 *
	 ...
	 * Preconditions: None
	 *
	 * Postconditions: The tree rooted at this node is unchanged.
	 *
	...
	/**
	 * Locate the parent of the given node looking in the tree whose root is
	 * this node.
	 *
	 ...
	 *
	 * @param target
	 *            the node whose parent is to be located.
	 *
