...
public class Vertex {
	 ...
	 * Preconditions: None
	 *
	 * Postconditions: The vertex is unchanged.
	 *
	 ...
	 * Preconditions: None
	 *
	 * Postconditions: The flag has the given value.
	 *
	 * @param newTag
	 *            the tag's new value.
	 */
	...
	/**
	 * Add an edge to this vertex. If the edge already exists, it will be
	 * replaced by the new edge.
	 *
	 * Preconditions: The edge is not null. The source of the edge is this
	 * vertex.
	 *
	 * Postconditions This Vertex has the specified edge.
	 *
	 * @param theEdge
	...
	/**
	 * Get the edge that starts at this vertex and ends at the vertex with the
	 * given name.
	 *
	 * Preconditions: The name is not null.
	 *
	 * Postcondtions: The vertex is not changed.
	 *
	 * @param name
	 *            the name of the destination vertex.
	 *
	 * @return a reference to the edge that leads from this vertex to the
	 *         specified vertex or null if the edge does not not exist.
	 */
	...
	/**
	 * Determine if the vertex with the given name is a neighbor of this vertex.
	 *
	 * Preconditions: The name is not null.
	 *
	 * Postconditions: The vertex is not changed.
	 *
	 * @param name
	 *            the name of the vertex.
	 *
	 * @return true if one of the neighbors of this vertex has the the specified
	 ...
	 * Postconditions: The vertex is unchanged.
	 *
	 * @return a list containing all of the vertices that are neighbors of this
	 *         vertex.
	 */
	 ...
	 * Postconditions: The vertex is unchanged.
	 *
	 * @return a list containing all of the edges that start from this vertex.
	 */
