...
public interface Table<K, V> {
	 ...
	 *
	 * Preconditions: Key is not null Value is not null
	 *
	 * Postconditions: The given value has been associated with the given key.
	 *
	 * @param key
	 *            the key to refer to the given value by.
	 * @param value
	 ...
	 *
	 * Postconditions: The element (if any) identified by key has been removed.
	 *
	 * @param key
	 *            the key to remove.
	 */
	 ...
	 * Preconditions: Key is not null.
	 *
	 * Postconditions: The Table is unchanged.
	 *
	 * @param key
	 *            the key to look up in the table.
	 *
	 * @return the object associated with the key or null if the key is not in
	 *         the table.
	 */
	public V get(K key);
	...
	/**
	 * Get all values stored in this Table. There is no correlation between the
	 * order of the elements returned by this method and the getKeys() method.
	 *
	 * Preconditions: None
	 *
	 * Postconditions: The Table is unchanged.
