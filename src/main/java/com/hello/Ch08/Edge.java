...
public class Edge implements Comparable<Edge> {
	...
	public String toString() {
		return "(" + source.getName() + "->" + dest.getName() + ":" + cost
				+ ")";
	}
	...
	public boolean equals(Object other) {
		...
		if (other instanceof Edge) {
			...
			retVal = source.equals(otherEdge.source)
					&& dest.equals(otherEdge.dest) && cost == otherEdge.cost;
		}
	...
	/**
	 * Compare this edge to another edge. Edges are compared based on their
	 * cost. If the costs are the same the edges will be ordered based on the
	 * names of the vertices that they connect.
	 *
	 * @param other
