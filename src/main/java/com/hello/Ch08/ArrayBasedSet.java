...
/**
 * An array based implementation of a set. Javadoc comments for methods
...
public class ArrayBasedSet<T> implements Set<T> {
	...
	public static void main(String args[]) {
		...
		System.out.println("t contains 2? " + t.contains(new Integer(2)));

		System.out.println("t contains 3? " + t.contains(new Integer(3)));
