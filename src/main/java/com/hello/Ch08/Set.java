...
public interface Set<T> {
	 ...
	 * 
	 * Preconditions: This set is not full. e is not null.
	 *
	 * Postconditions: e is contained in this set.
	 * 
	 * @param e
	 *            the element to add.
	 ...
	 * 
	 * Preconditions: This set is not empty and e is not null.
	 *
	 * Postconditions: e is not contained in this set.
	 * 
	 * @param e
	 ...
	 *
	 * Postconditions: This set contains the union of this set and s.
	 * 
	 * @param s
	 ...
	 * Preconditions: s is not null.
	 *
	 * Postconditions: This set contains the intersection of this set and s.
	 * 
	 * @param s
	...
	/**
	 * Remove all elements in this set which are members of the given set (i.e.,
	 * retains those elements not in the given set).
	 * 
	 * Preconditions: s is not null.
	 *
	 * Postconditions: This set contains the difference of this set and s.
	 *
	 * @param s
	 ...
	 * Preconditions: None
	 *
	 * Postconditions: The set is unchanged.
	 * 
	 ...
	 * 
	 * @param e
	 *            the object to check for set membership.
