...
/**
 * A hash table that uses open addressing. Javadoc comments for methods
 * specified in the Set interface have been omitted.
 *
 *
...
public class OpenAddressingHashTable<K, V> implements Table<K, V> {
	...
	/**
	 * Return the location in the table where the tuple with the specified key
	 * is found. A -1 is returned if the key cannot be found in the table.
	 *
	 * @param key
	 *            the key to search the table for.
	 * @return the location of the key in the table or -1 if the key cannot be
	 *         found.
	 */
