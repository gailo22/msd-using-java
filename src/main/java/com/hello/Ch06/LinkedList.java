...
public class LinkedList<T> implements List<T> {
	 ...
	 * Preconditions: None
	 *
	 * Postconditions: The cursor is set to the first element in the list. The
	 ...
	 * Preconditions: None
	 *
	 * Postconditions: The cursor is set to the last element in the list. The
	 * list's structure and content are unchanged.
	 */
	public void last() {
		cursor = last;
	 ...
	 *
	 * Postconditions: The element at the specified position was removed from
	 * the list. The size of the list is decreased by 1. If the element that was
	 * removed was the last element in the list, the cursor is moved off the
	 * list. Otherwise the cursor is moved to the removed element's successor.
	 *
	 * @param position
	 ...
	 * specified by the cursor. The size of the list has increased by 1. The
	 * cursor refers to the element added to the list.
	 *
	 * @param element
	 ...
	 *
	 *         Postconditions: The list's structure, content, and cursor are
	 *         unchanged.
	 *
	 * @return the element the cursor refers to.
	 */
	 ...
	 *
	 * @return a reference to the node before the node referred to by the
	 *         cursor.
	 */
