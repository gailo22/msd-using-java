...
public class PrioritizedLinkedNode<T> {
	...
	private PrioritizedLinkedNode<T> next; // The next node in the data
											// structure
	 ...
	 * Preconditions: None
	 *
	 * Postconditions: Node's priority has been updated.
	 * 
	 * @param p
	 *            this datum's priority
	 *
	 */
	 ...
	 * Preconditions: None
	 *
	 * Postconditions: Node is unchanged.
	 *
