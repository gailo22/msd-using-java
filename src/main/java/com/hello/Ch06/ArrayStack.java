...
public class ArrayStack<T> implements Stack<T> {
	 ...
	 * Preconditions: None
	 *
	 * Postconditions: The ArrayStack is ready for use
	 */
	public ArrayStack() {
	 ...
	 * 
	 * Postconditions: Stack size has decreased by 1. The top item of the stack
	 * has been removed. The rest of the stack is unchanged.
	 */
	public void pop() {
	 ...
	 * 
	 * Postconditions: Stack size has increased by 1. data is on top of the
	 * stack. The rest of the stack is unchanged.
	 * 
	 * @param data
	 *            the object to place on the stack
	 */
	 ...
	 * 
	 * Postconditions: The stack is unchanged.
	 *
