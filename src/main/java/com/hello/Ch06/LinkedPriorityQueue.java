...
public class LinkedPriorityQueue<T> implements Queue<T> {
	 ...
	 * 
	 * Postconditions: The size of the queue has decreased by one. The first
	 * item of the queue has been removed. No other structure of the queue has
	 * changed.
	 */
	public void dequeue() {
	 ...
	 * Preconditions: The queue is not empty.
	 *
	 * Postconditions: The queue is unchanged.
	 *
	 * @return the item at the front of the queue.
	 */
	public T front() {
	...
	/**
	 * Add an element to the queue. The item is added with minimum priority.
	 * This method must be provided to satisfy the Queue interface.
	 *
	 * Preconditions: The queue is not full.
	 * 
	 * Postconditions: The value V has been added to the back of queue The size
	 * of the queue has increased by one No other structure of the queue has
	 * changed.
	 *
	 * @param data
	...
	public void enqueue(T data, int priority) {
		...
		PrioritizedLinkedNode<T> newNode = new PrioritizedLinkedNode<T>(data,
				priority);
