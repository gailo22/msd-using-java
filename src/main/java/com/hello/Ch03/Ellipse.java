...
/**
 * A class that represents an ellipse. The state of an ellipse consists of its
 * height, width, and a point object. The point object specifies the location of
 * the upper left hand corner of the smallest rectangle that bounds the ellipse.
 */
...
public class Ellipse {
	...
	public Ellipse(Rectangle boundingBox) {
		this(boundingBox.getLocation(), boundingBox.getHeight(), boundingBox
				.getWidth());
	}
	...
	/**
	 * Return an approximation of the perimeter of this ellipse. This
	 * approximation is is reasonable only for ellipses which are nearly cicular
