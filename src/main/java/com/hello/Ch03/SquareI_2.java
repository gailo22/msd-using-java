...
/**
 * A class that represents a square. The state of a square consists of the
 * length of its side and a point object. The point object specifies the
 * location of the center of the square.
 */

public class SquareI_2 implements ShapeI {
	 ...
	 *
	 * @param length
	 *            the length of one of the sides of the square.
	 */

	public SquareI_2(double length) {
	...
	public SquareI_2(Point center, double length) {
		side = length;
	 ...
	 *
	 * @return a point that gives the location of the center of the square.
	 */
	...
	public String toString() {
		return ("Square:  length=" + side + " area=" + getArea()
