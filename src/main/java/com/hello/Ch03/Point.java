...
public class Point {
	...
	/**
	 * Return the nujmber of Point objects that have been created thus far.
	 *
	 * @param the
	 *            number of point objects that have been created.
	 */
	 ...
	 *
	 * @param value
	 *            the value to set the X and Y coordinates to.
	 */
	 ...
	 * 
	 * @param value
	 *            the value to set the X and Y coordinate to.
	 */
	...
	/**
	 * Set the X and Y coordinate equal to the X and Y coordinates of the point
	 * passed as a parameter.
	 *
	 * @param p
	 *            the point used to obtain the new X and Y coordinates.
	 */
	...
	/**
	 * Determine the distance between this point and the origin (i.e. the
	 * distance between this point and a point at location (0,0).
	 *
