...
public class Param {
	/**
	 * Create and initialize a Point and an int value. Print the values of these
	 * variables before and afcter invoking the method aMethod().
	 *
	 * @param args
	 ...
	 *            the point to move
	 * @param deltaX
	 *            amount to move the x-coordinate
	 * @param deltaY
	 *            amount to move the y-coordinate
	 */
	...
	/**
	 * Convert the given point to string form suitable for printing
	 *
	 * @param p
