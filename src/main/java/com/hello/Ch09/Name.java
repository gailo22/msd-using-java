...
/**
 * A class that represents a name consisting of a first and last name.
 */
public class Name implements Comparable<Name> {
	...
	/**
	 * Compare two names and determine their relative order. This method will
	 * first comapre the last names. If they are different there alphabetical
	 * order will determine the order of the names. If the last names are the
	 * same, the first names will be used to determine the order.
	 *
	 * @param otherName
	 *            the name to compare this name to.
	 * @return a negative number if this name is less than the given name, zero
	 *         if the names are equal, and a positive number if this name is
