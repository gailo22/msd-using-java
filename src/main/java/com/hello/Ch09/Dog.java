...
/**
 * A class that represents a dog. The state of a dog consists of its name,
 * breed, and gender. Note that this class is not comparable.
 */
public class Dog {
	// State for the dog
	...
	/**
	 * Return a hash value for this object; the hash value for a dog object is
	 * equal to the sum of the hash codes for the name. breed, and gender of the
	 * dog.
	 *
