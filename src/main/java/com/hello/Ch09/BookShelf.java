...
/**
 * A class that represents a bookshelf. Books on the shelf are stored and
 * retrieved by ISBN.
 */
public class BookShelf {
	...
	/**
	 * Add a book to the bookshelf. The book is added only if a book with the
	 * same ISBN is not already on the shelf. The return value indicates whether
	 * or not the book was added to the shelf.
	 *
	 * @param isbn
	 ...
	 *
	 * @param isbn
	 *            the ISBN of the title to be retrieved.
	...
	/**
	 * Remove the title with the specified title from the shelf. The return
	 * value indicates whether the title was removed from the shelf or not.
	 *
	 * @param isbn
	 *            the ISBN of the title to remove.
