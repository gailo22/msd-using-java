...
/**
 * Use a user thread to perform some complicated time consuming computation. The
 * main thread will wait for the worker thread using the yield() method.
 */
public class YieldingMain extends Thread {
	...
	/**
	 * Create and start thread to perform computation. Wait until the thread has
	 * finished before printing the result.
	 * 
	 * @param args
