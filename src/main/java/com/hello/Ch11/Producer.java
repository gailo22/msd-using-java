...
/**
 * The producer side of the Producer/Consumer problem. This thread generates a
 * stream of integers and feeds them to a consumer through a buffer.
 */
...
public class Producer extends Thread {
	 ...
	 *
	 * @param buf
	 *            the buffer that is connected to the consumer.
	 * @param count
