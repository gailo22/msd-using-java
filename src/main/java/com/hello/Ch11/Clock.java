...
/**
 * Once every second print the elapsed time since the program was started.
 */
public class Clock {
	...
	/**
	 * The main program consists of an infinite loop that sleeps for one second,
	 * updates the current time, and prints the result.
	 * 
	 * @param args
