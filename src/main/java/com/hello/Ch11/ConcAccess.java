...
public class ConcAccess extends Thread {
	...
	/**
	 * Obtain a local copy of common, increment the copy by one and store the
	 * result back in common.
	 */
	public void run() {
	...
	/**
	 * Create and start three threads that will each add one to common. Print
	 * common when all threads have died.
	 * 
	 * @param args
