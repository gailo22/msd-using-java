...
/**
 * A simple example to demonstrate the use of notifyAll() in java. This program
 * simulates a number of customers who wish to check out of a store. An instance
 * of a cashier is used to control the order in which customers are serviced.
 */
public class Customer extends Thread {
	...
	/**
	 * Create a new customer with the specified id, wishing to go through the
	 * specified register.
	 *
	 * @param id
	 *            this customer's id
	 * @param register
	 *            the cashier who will service this customer
	 */
	public Customer(int id, Cashier register) {
		...
		System.out.println("Customer " + id + " has " + numItems + " items.");
	}

	/**
	 * This method simulates the behavior of a customer. The customer requests
	 * to move to the head of the line. Once there checks out, and then leaves
	 * the line.
	 */
	public void run() {
