...
/**
 * A cashier that gives priority access to customers that have ten items or
 * less.
 */
public class Cashier2 implements Cashier {
	 ...
	 * wait until the other customer has finished with the cashier. Customers
	 * with 10 or fewer items will be allowed to move ahead of the other
	 * customers.
	 */
	 ...
	 * customers are waiting for the cashier, customers with 10 or fewer items
	 * will be allowed to get to the head of the line before the other
	 * customers.
	 */
