...
/**
 * Create five threads, each with a different name. Each thread prints its name
 * on standard output and terminates.
 */
public class MultipleThreads extends Thread {
	...
	/**
	 * Create NUM_THREADS threads, start each thread, and terminate. The name of
	 * each thread will be of the form "Thread #N" where N will be replaced by a
	 * number from 0 to NUM_THREADS - 1.
	 * 
	 * @param args
