...
/**
 * This class represents the external environment that a room is contained in.
 * The primary role of this class is to maintain the outside temperature. We
 * will be using a fixed outdoor temperature, but it could be modified to cvary
 * according to some enironmental rules.
 */
public class Environment {
	 ...
	 * 
	 * @param newTemp
	 *            temperature to set the environment to.
	 */
