...
public class TestFurnace {
	...
	public static void main(String args[]) {
		...
		System.out.println("f1 Capacity = " + f1.getCapacity()
				+ " Efficiency = " + f1.getEfficiency() + " Heating state = "
				+ f1.isHeating());

		System.out.println("f2 Capacity = " + f2.getCapacity()
				+ " Efficiency = " + f2.getEfficiency() + " Heating state = "
				+ f2.isHeating());

		System.out.println("f3 Capacity = " + f3.getCapacity()
				+ " Efficiency = " + f3.getEfficiency() + " Heating state = "
				+ f3.isHeating());

		// Now see if we can change the state of a Furnace
		f1.setHeating(true);
		System.out.println("New heating state of f1 = " + f1.isHeating());

		f2.setHeating(true);
		System.out.println("New heating state of f2 = " + f2.isHeating());

		f3.setHeating(true);
		System.out.println("New heating state of f3 = " + f3.isHeating());
