...
/**
 * The master clock for the home heating simulation. Generates tick events for
 * ClockListeners that have been registered with the clock. The interval between
 * ticks is determined at the time the clock is constructed.
 */
public class Clock {
	...
	/**
	 * Create a new clock that will generate tick events at the specified
	 * interval.
	 *
	 * @param tickInterval
	...
	/**
	 * Run the clock for the specified number of ticks. The state of the clock
	 * is valid between invocations of run(). This makes it possible to call run
	...
	/**
	 * Add a listener to the collection of objects that are notified when tick
	 * events occur.
	 *
	 * @param entity
