...
/**
 * This class represents a thermostat in the home heating simulation program.
 * The thermostat monitors a single room and turns on the furnace whenever the
 * room temperature falls below the desired setting. The thermostat will
 * overheat the room slightly so that the furnace will not cycle on and off too
 * quickly.
 */
public class Thermostat implements ClockListener {
	 ...
	 *
	 * @param theRoom
	 *            the room that will be monitored by this thermostat.
	 * @param theFurance
	 *            the furnace that will add heat to the room.
	 */
	 ...
	 */
	public Thermostat(Room theRoom, Furnace theFurnace, double desiredTemp) {
	 ...
	 * @param desiredTemp
	 *            the desired room temperature.
	 * @param overheatAmount
	 *            the amount that the room will be overheated.
	 */
	public Thermostat(Room theRoom, Furnace theFurnace, double desiredTemp,
	 ...
	 *
	 * @return the furnace that the thermostat will use to add heat to the room.
	 */
	 ...
	 *
	 * @param newSetting
	 *            the new temperature setting for the thermostat.
	 */
	...
	/**
	 * Base the decision to turn on/off the furnace on the temperature of the
	 * room during the past time period.
	 *
	 * @param interval
	...
	/**
	 * This method is called before the next event occurs so that the thermostat
	 * can determine whether what it should do to the furnace (i.e., turn it on,
	 * turn it off, or leave it alone) based on what has happened since the last
	 * event. The thermostat will not change its state when this method is
	 * called. It prepares itself for the state change that will occur when the
	 * next event occurs.
	 *
	 * @param interval
	 *            the number of seconds that have elapsed since the last event.
	...
	public String toString() {
		return "[ Thermostat: " + " setting=" + setting + " overheat="
				+ overHeat + "]";
	}
}
