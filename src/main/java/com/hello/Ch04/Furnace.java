...
/**
 * A furnace in the home heating simulation. When on a furance will produce a
 * certain number of BTUs/hour of heat. The furance has a capacity which gives
 * the maxmimum number of BTUs it can generate and an efficiency which
 * determines what percentage of the furnace's capacity is actually generated as
 * output.
 */
public class Furnace {
	 ...
	 *
	 * @param cap
	 *            the capacity of the furance in BTUs/hr
	 * @param eff
	 ...
	 *
	 * @param onOff
	 *            if true the furnace will produce heat.
	 */
	...
	/**
	 * Return the number of BTUs produced by the furnace during the specified
	 * period of time.
	 *
	 * @param hours
	 *            number of hours the furnance has been on.
	 * @return the number of BTUs produced by the furnace during the specified
	 *         time period.
	 */
	...
	public String toString() {
		return "[ Furnace:" + " cap=" + capacity + " eff=" + efficiency
				+ " heating=" + heating + " ]";
	}
}
