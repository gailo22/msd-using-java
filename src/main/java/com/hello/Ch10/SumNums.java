...
public class SumNums {
	...
	/**
	 * Read lines from the buffered reader and convert the integer values on
	 * those lines to numbers. The sum of the numbers is returned. Note that
	 * this method takes a buffered reader as parameter and it does not care if
	 * the buffered reader is connected to a file or the standard input stream.
	 *
	 * @param in
	 *            the buffered reader to process.
	 *
