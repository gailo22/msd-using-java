...
public class BinarySearch {
	...
	/**
	 * Search the given array for the given integer using a binary search. This
	 * method assumes that the elements in the array are in sorted order. If the
	 * element is found, the method returns the position of the element,
