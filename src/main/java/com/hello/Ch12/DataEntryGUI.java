...
/**
 * Display a simple data entry screen. This program illustrates the use of
 * listeners and a JComboBox.
 */
public class DataEntryGUI extends JFrame implements ActionListener {
	...
	private static final String stateList[] = { "AK", "AL", "AR", "AZ", "CA",
	...
	private static final String fieldName[] = { "Name:", "School:", "Major:",
			"Hometown:" };
	...
	private JTextArea displayArea = new JTextArea(NUM_FIELDS, DATA_LENGTH);
	...
	/**
	 * This method will be invoked whenever one of the buttons on the GUI is
	 * pressed.
	 *
	 * @param e
	 *            the event that caused this method to be invoked.
	 */
