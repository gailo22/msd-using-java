...
/**
 * A GUI that incorporates components such as buttons, labels, and text fields.
...
public class ListenerDemo extends JFrame implements ActionListener {
	...
	/**
	 * This method will be invoked whenever one of the two buttons in the GUI
	 * are pressed. The label that appears in the button that was pressed will
	 * be displayed in the text field on the screen.
	 *
	 * @param e
	...
	/**
	 * Create an instance of a ListenerDemo and display it on the screen.
	 */
