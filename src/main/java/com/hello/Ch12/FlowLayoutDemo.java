...
public class FlowLayoutDemo {
	...
	public static void main(String args[]) {
		...
		left.setBorder(BorderFactory.createTitledBorder(
				BorderFactory.createLineBorder(Color.BLACK), "Left Alignment"));
		...
		center.setBorder(BorderFactory.createTitledBorder(
				BorderFactory.createLineBorder(Color.BLACK), "Center Alignment"));
		center.add(new JButton("Component 1"));
		center.add(new JButton("Component 2"));

		JPanel right = new JPanel(new FlowLayout(FlowLayout.RIGHT));
		right.setBorder(BorderFactory.createTitledBorder(
				BorderFactory.createLineBorder(Color.BLACK), "Right Alignment"));
