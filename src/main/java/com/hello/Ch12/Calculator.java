...
public class Calculator extends JFrame implements ActionListener {
	...
	/**
	 * Return the current contents of the display portion of the GUI.
	 *
	 ...
	 *
	 * @param text
	 *            the value to place in the display.
	 */
	...
	/**
	 * Invoked whenever a user presses a button. The button press is simply
	 * passed on to the calculator engine which processes the button and updates
